      % This program plots 15 basis functions for the triangular and the 
      ...
      for k = 1:N
          ...
          set(gca,'XTick',[],'YTick',[])
          axis square
          title(['$\mathrm{X}_{\mathcal{R},(',num2str(gam1(k)),',',num2str(gam2(k)),')}$'],'interpreter','latex','fontsize',20)
      end  
      ...
      for k = 1:N
          ...
          set(gca,'XTick',[],'YTick',[])
          axis square
          title(['$\mathrm{X}_{\mathcal{R},(',num2str(gamsq1(k)),',',num2str(gamsq2(k)),')}$'],'interpreter','latex','fontsize',20)
      end